...
const DateTimeInput = React.forwardRef<HTMLInputElement, DateTimeInputProps>((options: DateTimeInputProps, ref) => {
  ...
  return (
    <div className="flex flex-col gap-1">
      <div
        className={cn(
          'flex h-10 items-center justify-start rounded-md border border-input bg-transparent dark:bg-input/30 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground  disabled:cursor-not-allowed disabled:opacity-50',

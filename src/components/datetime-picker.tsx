...
export function DateTimePicker({
  ...
  const triggerProps: DateTimeRenderTriggerProps = {
    value: displayValue,
    open,
    timezone,
    disabled,
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      {/*
        Custom triggers (e.g. DateTimeInput) often don't forward refs/Slot props.
        Use PopoverAnchor for positioning and let the trigger control `open` via setOpen.
      */}
      {renderTrigger ? (
        <PopoverAnchor asChild>
          <div className="w-full">{renderTrigger(triggerProps)}</div>
        </PopoverAnchor>
      ) : (
